...
import { ModalController, ActionSheetController, PopoverController } from '@ionic/angular/standalone';
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: ActionSheetController, useValue: { create: jasmine.createSpy() } },
        { provide: PopoverController, useValue: { create: jasmine.createSpy() } },
      ],
    }).compileComponents();

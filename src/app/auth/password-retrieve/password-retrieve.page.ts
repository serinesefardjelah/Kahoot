...
@Component({
  ...
  `,
  styles: [`
    .retrieve-content { --background: #f8f5ff; }
    ...
    .hero-emoji { font-size: 3rem; display: block; margin-bottom: 0.4rem; }

    .hero-title {
      margin: 0; font-size: 2.4rem; font-weight: 900; color: #ffffff;
    }

    .hero-sub { margin: 0.3rem 0 0; color: rgba(255,255,255,0.7); font-size: 0.95rem; }
    ...
    .form-title { margin: 0 0 0.25rem; font-size: 1.5rem; font-weight: 800; color: #1a0f2e; }
    .form-sub { margin: 0 0 1.75rem; color: #9ca3af; font-size: 0.875rem; }

    .input-group { margin-bottom: 1rem; }

    .input-label {
      display: block; font-size: 0.8rem; font-weight: 600;
      color: #4b5563; margin-bottom: 0.35rem;
    }
    ...
    .switch-text {
      text-align: center; margin: 1.5rem 0 0; color: #9ca3af; font-size: 0.9rem;
    }

    .switch-text a { color: #7c3aed; font-weight: 700; text-decoration: none; }
  `],
  imports: [IonButton, IonContent, IonInput, CommonModule, ReactiveFormsModule, RouterLink]
})
